                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.order.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
...
{{--                                    <h4>@lang('site.total') : {{$order->total_price}}</h4>--}}
